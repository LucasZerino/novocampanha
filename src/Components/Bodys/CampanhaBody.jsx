              ...
              <div class="col-sm-6 col-md-3">  
                <div class="form-group form-focus">
                 <div class="linha">
                  ...
                  <input type="text" class="form-control floating" placeholder="Digite o nome da campanha..."/>
                 </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-3">  
                <a onClick={() => navigate(`/mezap/campanhas/criar`)} class="btn btn-primary btn-block">
                  <span></span>
                  <span></span>
                  <span></span>
                  <span></span>
              ...
              <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                <div class="profile-widget">
                  <div class="profile-img">
                   <img class="avatar" src={campanhaicon} alt=""/>
                  </div>
                  <div class="texto">
                    <a href="perfil.html"><h1>NPS - Teste</h1></a> 
                    <h2>Iniciada no dia: 31/12/2022-12:00</h2>
                    <h3>Finalizada no dia: 31/12/2022-12:00</h3>
                  </div>
                </div>
              </div>
            </div>
