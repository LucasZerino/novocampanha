...
const PageHeader = () => {
    ...
    const tirarside =() => {
      console.log(document.getElementById('main-nav').classList.length)
      if(document.getElementById('main-nav').classList.length===1){
        document.getElementById('main-nav').classList.add("none");
      }else{
        document.getElementById('main-nav').classList.remove("none");
      }
    }
    ...
    <div className="page-main-header">
        <div className="main-header-right row m-0">
          <div className="main-header-left">
            ...
            <div onClick={tirarside} className="toggle-sidebar"><i data-feather="align-center" id="sidebar-toggle"><MenuIcon fontSize="large"/></i></div>
          </div>
